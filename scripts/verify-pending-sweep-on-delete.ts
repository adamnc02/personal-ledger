...
const afterLoanSweep = sweepPendingForLoan(loanTxns, loan)
...
const afterCardSweep = sweepPendingForCreditCard(cardTxns, 'card-1')
...
const afterPotSweep = sweepPendingForSavingsPot(potTxns, 'pot-1')
...
const afterTemplateSweep = sweepPendingForSource(templateTxns, 'recurring_template', 'template-1')
...
const afterPensionSweep = sweepPendingForSource(pensionTxns, 'pension', 'pension-1')
